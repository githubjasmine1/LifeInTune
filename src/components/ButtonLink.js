...
const ButtonLink = ({ as: As = Link, className, icon, children, ...props }) => {
  return (
    <As
      className={`flex justify-center items-center relative py-2 px-10 font-display font-hariline text-sm leading-relaxed text-center uppercase rounded-full hover:text-white ${className}`}
      css={{
